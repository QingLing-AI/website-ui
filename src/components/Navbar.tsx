      ...
      <nav className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6 lg:space-x-8 items-center">
          ...
          <button 
            ...
            className="px-3 py-1 rounded border border-gray-300 hover:border-primary text-gray-600 hover:text-primary transition-colors text-sm font-medium"
          >
        ...
        <div className="flex items-center md:hidden space-x-4">
           <button 
            onClick={toggleLanguage}
            className="px-2 py-1 rounded border border-gray-300 text-gray-600 text-xs font-medium"
          >
            {i18n.language.startsWith('zh') ? 'EN' : '中'}
          </button>
          <button 
