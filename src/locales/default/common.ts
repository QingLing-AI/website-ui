export default {
  ...
  contact: {
    ...
    form: { name: "您的姓名", email: "电子邮箱", phone: "联系电话", msg: "留言内容", btn: "提交信息", submitting: "提交中..." },
    info: { title: "联系方式", addrTitle: "公司地址", addr: "香港观塘伟业街221号美德工业大厦D座10楼D5室", phoneTitle: "联系电话", emailTitle: "电子邮箱", hoursTitle: "工作时间", hours: "周一至周五: 9:00 - 18:00", follow: "关注我们" }
  },
  footer: {
